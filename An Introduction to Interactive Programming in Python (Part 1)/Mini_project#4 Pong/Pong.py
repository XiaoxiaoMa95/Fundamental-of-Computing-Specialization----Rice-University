...
def spawn_ball(direction):
    ...
    if direction == 'left':
        # ball should be upwards and towards the right
        ball_vel[0] = -ball_vel[0]
        ball_vel[1] = -ball_vel[1]
    else:
        # ball should be upwards and towards the left
        ball_vel[1] = -ball_vel[1]
...
def draw(canvas):
    ...
    if ball_pos[1] < BALL_RADIUS or ball_pos[1] > HEIGHT - BALL_RADIUS:
        # collision and reflection with top or bottom wall
        ball_vel[1] = -ball_vel[1]
    elif ball_pos[0] < BALL_RADIUS + PAD_WIDTH:
        # collision with the left gutteror paddle
    ...
    canvas.draw_polygon([[0, paddle1_pos[1] + HALF_PAD_HEIGHT], [PAD_WIDTH, paddle1_pos[1] + HALF_PAD_HEIGHT],
                        ...
                        1, 'White', 'White')
    canvas.draw_polygon(
        [[WIDTH - PAD_WIDTH, paddle2_pos[1] + HALF_PAD_HEIGHT], [WIDTH, paddle2_pos[1] + HALF_PAD_HEIGHT],
         [WIDTH, paddle2_pos[1] - HALF_PAD_HEIGHT], [WIDTH - PAD_WIDTH, paddle2_pos[1] - HALF_PAD_HEIGHT]],
        1, 'White', 'white')

    # draw scores
    canvas.draw_text(str(score1) + "    " + str(score2), (WIDTH / 2 - 50, 50), 55, "White")
